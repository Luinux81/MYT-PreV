...
if(isset($_SESSION["username"])){
    ...
    $lista=Ticket::listadoTickets($_SESSION["Filtro"]);
    ...
    echo "<h1>Tickets</h1>
          <form action='./filtro.php' name='filtro_tickets' method='post'>
            <select name='NombreParametro'>
                <option>IdCompra</option>
                <option>Codigo</option>
            </select>
            <input type='text' name='Parametro'>
            <input type='submit' name='Filtrar'>
            <input type='hidden' name='origen' value='tickets'>
          </form>
    ";
